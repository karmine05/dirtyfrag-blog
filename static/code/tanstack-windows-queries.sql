-- ============================================================================
-- Mini Shai-Hulud Mass-Compromise — Windows
...
--
-- KNOWN LIMITATION: No host-level Windows persistence IOC is publicly
-- documented for this campaign. Treat a clean Windows result with marginally
-- less confidence than macOS/Linux.
-- ============================================================================
...
WHERE path LIKE 'C:\Users\%\%%\node_modules\%\router_init.js'
   OR path LIKE 'C:\Users\%\%%\node_modules\@%\%\router_init.js'
   OR path LIKE 'C:\Users\%\AppData\Roaming\npm\node_modules\%\router_init.js'
   OR path LIKE 'C:\Users\%\AppData\Roaming\npm\node_modules\@%\%\router_init.js'
...
WHERE path LIKE 'C:\Users\%\%%\node_modules\@tanstack\setup\tanstack_runner.js'
   OR path LIKE 'C:\Users\%\AppData\Roaming\npm\node_modules\@tanstack\setup\tanstack_runner.js'
   OR path LIKE 'C:\Program Files\nodejs\node_modules\@tanstack\setup\tanstack_runner.js'
...
WHERE path LIKE 'C:\Users\%\%%\.claude\router_runtime.js'
   OR path LIKE 'C:\Users\%\%%\.claude\setup.mjs'
   OR path LIKE 'C:\Users\%\%%\.vscode\setup.mjs';
