-- ============================================================================
-- Mini Shai-Hulud Mass-Compromise — Linux
-- Source: Socket.dev feed (snapshot 2026-05-12), 175 packages / 406 versions
-- See tanstack-macos-queries.sql for namespace and source details.
-- ============================================================================
...
SELECT 'CRITICAL_persistence_systemd_service' AS indicator, path FROM file
WHERE path LIKE '/home/%/.config/systemd/user/gh-token-monitor.service'
   OR path LIKE '/root/.config/systemd/user/gh-token-monitor.service'

UNION ALL

SELECT 'CRITICAL_persistence_monitor_script' AS indicator, path FROM file
WHERE path LIKE '/home/%/.local/bin/gh-token-monitor.sh'
   OR path LIKE '/root/.local/bin/gh-token-monitor.sh'

UNION ALL

SELECT 'CRITICAL_payload_router_init_js' AS indicator, path FROM file
WHERE path LIKE '/home/%/%%/node_modules/%/router_init.js'
   OR path LIKE '/home/%/%%/node_modules/@%/%/router_init.js'
   OR path LIKE '/root/%%/node_modules/%/router_init.js'
   OR path LIKE '/root/%%/node_modules/@%/%/router_init.js'
   OR path LIKE '/usr/lib/node_modules/%/router_init.js'
   OR path LIKE '/usr/lib/node_modules/@%/%/router_init.js'
   OR path LIKE '/usr/local/lib/node_modules/%/router_init.js'
   OR path LIKE '/usr/local/lib/node_modules/@%/%/router_init.js'
   OR path LIKE '/home/%/.nvm/versions/node/%/lib/node_modules/%/router_init.js'
   OR path LIKE '/home/%/.nvm/versions/node/%/lib/node_modules/@%/%/router_init.js'

UNION ALL

SELECT 'CRITICAL_payload_tanstack_runner_js' AS indicator, path FROM file
WHERE path LIKE '/home/%/%%/node_modules/@tanstack/setup/tanstack_runner.js'
   OR path LIKE '/root/%%/node_modules/@tanstack/setup/tanstack_runner.js'
   OR path LIKE '/usr/lib/node_modules/@tanstack/setup/tanstack_runner.js'
   OR path LIKE '/usr/local/lib/node_modules/@tanstack/setup/tanstack_runner.js'
   OR path LIKE '/home/%/.nvm/versions/node/%/lib/node_modules/@tanstack/setup/tanstack_runner.js'
...
WHERE path LIKE '/home/%/%%/.claude/router_runtime.js'
   OR path LIKE '/home/%/%%/.claude/setup.mjs'
   OR path LIKE '/home/%/%%/.vscode/setup.mjs'
   OR path LIKE '/root/%%/.claude/router_runtime.js'
   OR path LIKE '/root/%%/.claude/setup.mjs'
   OR path LIKE '/root/%%/.vscode/setup.mjs';
